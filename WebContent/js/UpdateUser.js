...
$(function(){
	$("#annulla").click(function(){
		...
		$("#annulla").hide();
		$("span").hide();
		$(".datibox").css("background-color","white");
	});
})
...
function formValidationRegistration(){
	...
	if(name.value == "" && surname.value == "" && born.value == "" && email.value == "" &&
		password.value == "" && repPassword.value == ""){
		noUpdate();
		return false;
	}
	else{
		if(name.value == "" || name_validation(name)){
			if(surname.value == "" || surname_validation(surname)){
				if(born.value == "" || born_validation(born)){
					if(email.value == "" || email_validation(email)){
...
function repPassword_validation(repPsw, psw){
	if((repPsw.value != psw.value) || (psw.value!="" && repPsw.value=="") || (psw.value=="" && repPsw.value!="")){
		$("#pswRepeatSpan").show();
